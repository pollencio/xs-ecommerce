...
/**
 * A lightweight, fully-owned select built on the native <select> element
 * (styled to match the rest of the UI) instead of a Radix primitive —
 * one fewer dependency for a boilerplate that only needs simple sort/filter
 * dropdowns.
 */
